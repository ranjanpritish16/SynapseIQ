...
export const ChevronUpSolidIcon = (props) => (
...
export const CubeIcon = (props) => (
    <svg {...base({ ...props, viewBox: "0 0 16 16", fill: "currentColor" })}>
...
export const LinkSolidIcon = (props) => (
    <svg {...base({ ...props, fill: "currentColor" })}>
        <path
            fillRule="evenodd"
            clipRule="evenodd"
...
export const SearchIcon = (props) => (
    <svg {...base({ ...props, viewBox: "0 0 20 20", fill: "currentColor" })}>
